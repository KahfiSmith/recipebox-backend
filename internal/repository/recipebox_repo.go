...
type RecipeBoxRepository interface {
	...
	ListRecipesPage(ctx context.Context, userID int64, limit, offset int) ([]models.Recipe, error)
	...
	ListMealPlansPage(ctx context.Context, userID int64, limit, offset int) ([]models.MealPlan, error)
	...
	ListShoppingItemsPage(ctx context.Context, userID int64, limit, offset int) ([]models.ShoppingItem, error)
